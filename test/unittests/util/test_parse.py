...
class TestNormalize(unittest.TestCase):
    ...
    def test_multiple_numbers(self):
        self.assertEqual(extract_numbers_generic("this is a one two "
                                                 "three  test"),
                         [1.0, 2.0, 3.0])
        self.assertEqual(extract_numbers_generic("it's  a four five "
                                                 "six  test"),
                         [4.0, 5.0, 6.0])
        ...
        #                                 "half test"),
        #                 [7.0, 8.0, 9.5])
        self.assertEqual(extract_numbers_generic("this is a ten eleven "
                                                 "twelve  test"),
                         [10.0, 11.0, 12.0])
        self.assertEqual(extract_numbers_generic("this is a one twenty "
                                                 "one  test"),
                         [1.0, 21.0])
        self.assertEqual(extract_numbers_generic("1 dog, seven pigs, "
